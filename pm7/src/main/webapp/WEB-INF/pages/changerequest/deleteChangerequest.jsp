...
<html>
<head>
<title>Confirm Delete <fmt:message key="changerequest.title"/></title>
</head>
<body>
...
<div style="padding-left:200px;padding-top:7px;padding-bottom:7px;background-color:rgb(239, 239, 239);">						
	<a class="button-red" href="${pageContext.request.contextPath}/deleteChangerequest?changerequestIdKey=${changerequest.changerequestId}&">Confirm Delete <img alt="" src="css/images/icons/icon-delete.png"></a>
