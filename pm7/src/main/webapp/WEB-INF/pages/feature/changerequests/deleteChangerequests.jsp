...
<html>
<head>
<title>View <fmt:message key="feature.title"/> <fmt:message key="changerequest.title"/></title>
</head>
<body>
						...
						<div class="tabs">
							<ul>
								...
								Feature-${feature_featureId}
									&nbsp;&nbsp;<fmt:message key="navigation.delete"/> <fmt:message key="changerequest.title"/> 
								</a></li>
							</ul>
...
<div style="padding-left:200px;padding-top:7px;padding-bottom:7px;background-color:rgb(239, 239, 239);">						
	<a class="button-red" href="${pageContext.request.contextPath}/deleteFeatureChangerequests?feature_featureId=${feature_featureId}&related_changerequests_changeId=${changerequest.changeId}&">Confirm Delete <img alt="" src="css/images/icons/icon-delete.png"></a>
