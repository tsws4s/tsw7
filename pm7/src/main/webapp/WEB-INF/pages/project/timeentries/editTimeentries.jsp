...
<html>
<head>
<title>Edit <fmt:message key="project.title"/> <fmt:message key="timeentry.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProjectTimeentries" method="POST" modelAttribute="timeentry">
