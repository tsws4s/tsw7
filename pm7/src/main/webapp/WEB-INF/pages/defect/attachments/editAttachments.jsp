...
<html>
<head>
<title>Edit <fmt:message key="defect.title"/> <fmt:message key="attachment.title"/></title>
</head>
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveDefectAttachments?defect_defectId=${defect_defectId}&" method="POST" modelAttribute="attachment" name="parentform">
						<div class="tabs">
							<ul>
