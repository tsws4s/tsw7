...
<html>
<head>
<title>Delete <fmt:message key="defect.title"/> <fmt:message key="attachment.title"/></title>
</head>
<body>
...
<div style="padding-left:200px;padding-top:7px;padding-bottom:7px;background-color:rgb(239, 239, 239);">						
	<a class="button-red" href="${pageContext.request.contextPath}/deleteDefectAttachments?defect_defectId=${defect_defectId}&related_attachments_attachId=${attachment.attachId}&">Confirm Delete <img alt="" src="css/images/icons/icon-delete.png"></a>
 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
