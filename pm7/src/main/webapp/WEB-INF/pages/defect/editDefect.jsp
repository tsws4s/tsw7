...
<html>
<head>
<title>Edit <fmt:message key="defect.title"/></title>
<script>
...
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveDefect" method="POST" modelAttribute="defect" name="parentform">
						<div class="tabs">
							<ul>
...
<div class="group fixed">
	<label>
		<fmt:message key="defect.defectname.title"/>:
							...
							<form:input id="defect_defectName" path="defectName" cssStyle="width:200px;"/>
