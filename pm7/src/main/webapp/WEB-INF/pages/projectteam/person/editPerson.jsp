...
<html>
<head>
<title>Edit <fmt:message key="projectteam.title"/> <fmt:message key="person.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProjectteamPerson" method="POST" modelAttribute="person">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="projectteam_projectTeamId" value="${projectteam_projectTeamId}" >
