...
<html>
<head>
<title>Edit <fmt:message key="projecttemplate.title"/> <fmt:message key="project.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProjecttemplateProject" method="POST" modelAttribute="project">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="projecttemplate_templateId" value="${projecttemplate_templateId}" >
