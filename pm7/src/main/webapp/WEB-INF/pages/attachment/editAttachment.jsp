...
<html>
<head>
<title>Edit <fmt:message key="attachment.title"/></title>
</head>
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveAttachment" method="POST" modelAttribute="attachment" name="parentform">
						<div class="tabs">
							<ul>
							...
							<c:choose>
								...
								<form:hidden id="attachment_attachmentId" path="attachmentId"/>
								</c:otherwise>
							</c:choose>
								</a></li>
							</ul>
