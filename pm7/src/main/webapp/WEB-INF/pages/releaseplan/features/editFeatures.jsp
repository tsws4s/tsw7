...
<html>
<head>
<title>Edit <fmt:message key="releaseplan.title"/> <fmt:message key="feature.title"/></title>
</head>
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveReleaseplanFeatures?releaseplan_releaseId=${releaseplan_releaseId}&" method="POST" modelAttribute="feature" name="parentform">
						<div class="tabs">
							<ul>
...
<div style="padding-left:200px;padding-top:7px;padding-bottom:7px;background-color:rgb(239, 239, 239);">						
	...
	<!--   Requirements   -->
			...
			<thead>
				<tr>
					<th>&nbsp;</th>
					<th><fmt:message key="requirement.reqmtid.title"/></th>
	...
	<!--   Changes   -->
			...
			<thead>
				<tr>
					<th>&nbsp;</th>
					<th><fmt:message key="changerequest.changeid.title"/></th>
					...
					<th><fmt:message key="changerequest.changedescription.title"/></th>
				</tr>
			</thead>
			<tbody>
				<c:set var="totalCount" value="0"/>
				<c:forEach items="${changerequests}" var="current" varStatus="i">
					<c:set var="totalCount" value="${totalCount+1}"/>
					<c:choose>
						<c:when test="${(i.count) % 2 == 0}">
		    				<c:set var="rowclass" value="rowtwo"/>
				...
				<tr class="${rowclass}">
				<td width="80px" class="center">
				<a class="icon" href="${pageContext.request.contextPath}/editChangerequest?changeIdKey=${current.changeId}&"><img src="css/images/icons/icon-edit.png" alt="Edit"></a>
				<a class="icon" href="${pageContext.request.contextPath}/confirmDeleteChangerequest?changeIdKey=${current.changeId}&"><img src="css/images/icons/icon-delete.png" alt="Delete"></a>
				</td>
	...
	<div style="padding-top:7px;padding-bottom:7px;background-color:rgb(239, 239, 239);">						
		<span style="padding-left:20px;">			
			<a class="button-blue" href="${pageContext.request.contextPath}/newChangerequest">New Changerequest <img src="css/images/icons/icon-menu-tasks.png" alt=""></a>
		</span>						
