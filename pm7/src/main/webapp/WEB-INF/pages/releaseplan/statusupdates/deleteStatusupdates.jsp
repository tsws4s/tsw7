...
<html>
<head>
<title>View <fmt:message key="releaseplan.title"/> <fmt:message key="statusupdate.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteReleaseplanStatusupdates?releaseplan_releaseId=${releaseplan_releaseId}&related_statusupdates_statusId=${statusupdate.statusId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
