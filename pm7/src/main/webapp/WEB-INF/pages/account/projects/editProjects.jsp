...
<html>
<head>
<title>Edit <fmt:message key="account.title"/> <fmt:message key="project.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAccountProjects" method="POST" modelAttribute="project">
