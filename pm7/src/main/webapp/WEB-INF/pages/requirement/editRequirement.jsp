...
<html>
<head>
<title>Edit <fmt:message key="requirement.title"/></title>
<script>
...
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveRequirement" method="POST" modelAttribute="requirement" name="parentform">
						<div class="tabs">
							<ul>
