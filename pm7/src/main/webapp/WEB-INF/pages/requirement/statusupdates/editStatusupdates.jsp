...
<html>
<head>
<title>Edit <fmt:message key="requirement.title"/> <fmt:message key="statusupdate.title"/></title>
<script>
...
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveRequirementStatusupdates?requirement_reqmtId=${requirement_reqmtId}&" method="POST" modelAttribute="statusupdate" name="parentform">
						<div class="tabs">
							<ul>
