...
<fmt:setBundle basename="bundles.application-resources"/>
	...
	<% } %>
		...
		<li class="${projectSelected}">	
			...
			<img src="css/images/icons/icon-dashboard-white.png" alt="Settings" />&nbsp;Projects </a></li>

		<li class="${releaseSelected}">	
			<a href="${pageContext.request.contextPath}/indexReleaseplan">
			<img src="css/images/icons/icon-calendar-white.png" alt="Settings" />&nbsp;Releases </a></li>
		
		<li class="${clientSelected}">
			<a href="${pageContext.request.contextPath}/indexClient">
			<img src="css/images/icons/icon-graph-white.png" alt="Settings" />&nbsp;Clients </a></li>
		
		<li class="${resourcesSelected}">
			<a href="${pageContext.request.contextPath}/indexProjectteam">
			<img src="css/images/icons/icon-menu-users.png" alt="Settings" />&nbsp;Resources </a></li>
		
		<li class="${acctSelected}">
			<a href="${pageContext.request.contextPath}/indexAccount">
			<img src="css/images/icons/icon-menu-settings.png" alt="Settings" />&nbsp;Account </a></li>
		
		<li class="${suppSelected}">	
			<a href="#"><img src="css/images/icons/icon-menu-messages.png" alt="Messages" />&nbsp; Support<img class="pin" src="css/images/back-nav-sub-pin.png" alt="" /></a>
				<ul>
