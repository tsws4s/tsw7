...
public class TimeentryDAOTest {
	 ...
	 *
	 */
	private TimeentryDAO dataStore;

	/**
	 * Instantiates a new TimeentryDAOTest.
	 *
	 */
	public TimeentryDAOTest() {
	}

	/**
	 * Method to test Timeentry domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(TimeentryDAO dataStore) {
