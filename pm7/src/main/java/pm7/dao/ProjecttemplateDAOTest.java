...
public class ProjecttemplateDAOTest {
	 ...
	 *
	 */
	private ProjecttemplateDAO dataStore;

	/**
	 * Instantiates a new ProjecttemplateDAOTest.
	 *
	 */
	public ProjecttemplateDAOTest() {
	}

	/**
	 * Method to test Projecttemplate domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(ProjecttemplateDAO dataStore) {
