...
public class InvoiceitemDAOTest {
	 ...
	 *
	 */
	private InvoiceitemDAO dataStore;

	/**
	 * Instantiates a new InvoiceitemDAOTest.
	 *
	 */
	public InvoiceitemDAOTest() {
	}

	/**
	 * Method to test Invoiceitem domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(InvoiceitemDAO dataStore) {
