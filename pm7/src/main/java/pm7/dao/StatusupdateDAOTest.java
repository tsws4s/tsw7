...
public class StatusupdateDAOTest {
	 ...
	 *
	 */
	private StatusupdateDAO dataStore;

	/**
	 * Instantiates a new StatusupdateDAOTest.
	 *
	 */
	public StatusupdateDAOTest() {
	}

	/**
	 * Method to test Statusupdate domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Statusupdate() {
		Statusupdate instance = new Statusupdate();
	 ...
	 */
	@Autowired
	public void setDataStore(StatusupdateDAO dataStore) {
