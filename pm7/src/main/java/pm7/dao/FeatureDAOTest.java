...
public class FeatureDAOTest {
	 ...
	 *
	 */
	private FeatureDAO dataStore;

	/**
	 * Instantiates a new FeatureDAOTest.
	 *
	 */
	public FeatureDAOTest() {
	}

	/**
	 * Method to test Feature domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(FeatureDAO dataStore) {
