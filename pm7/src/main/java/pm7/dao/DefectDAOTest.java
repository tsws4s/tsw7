...
public class DefectDAOTest {
	 ...
	 *
	 */
	private DefectDAO dataStore;

	/**
	 * Instantiates a new DefectDAOTest.
	 *
	 */
	public DefectDAOTest() {
	}

	/**
	 * Method to test Defect domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(DefectDAO dataStore) {
