...
public interface EventDAO extends JpaDao<Event> {
	 ...
	 *
	 */
	public Set<Event> findEventByEventUrl(String eventUrl_1) throws DataAccessException;

	/**
	 * JPQL Query - findEventByEventUrl
	 *
	 */
	public Set<Event> findEventByEventUrl(String eventUrl_1, int startResult, int maxRows) throws DataAccessException;
	...
	public Set<Event> findEventByDateAfter(Integer resource_resourceId,	Calendar afterDate, int indexFrom);
