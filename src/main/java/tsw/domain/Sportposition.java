...
@NamedQueries({
		...
		@NamedQuery(name = "findAllSportpositionsForSport", query = "select mySportposition from Sportposition mySportposition where sportFK = ?1"),
...
@Table(catalog = "tsws4s_4", name = "SportPosition")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "tsw7/tsw/domain", name = "Sportposition")
