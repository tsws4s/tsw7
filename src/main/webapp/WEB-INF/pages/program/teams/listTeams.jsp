	...
	<div class="panel">
		...
		<div class="button-bar">
			<span style="padding-left: 20px;"> 
				<input class="button-clean" type="button" name="new" value="New Team" onclick="location.href='${pageContext.request.contextPath}/newProgramTeams?program_programId=${program.programId}&amp;program_programName=${program.programName}&amp;'" />
			</span> 
			<span style="padding-left: 90px;"> 
				<input class="button-clean" type="button" name="games" value="Games" onclick="location.href='${pageContext.request.contextPath}/listProgramGames?programIdKey=${program.programId}&amp;'" />
			</span>
