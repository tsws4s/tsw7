...
<html>
<head>
<title>View <fmt:message key="sportstattype.title"/> <fmt:message key="sport.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteSportstattypeSport?sportstattype_sportStatTypeId=${sportstattype_sportStatTypeId}&related_sport_sportId=${sport.sportId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
