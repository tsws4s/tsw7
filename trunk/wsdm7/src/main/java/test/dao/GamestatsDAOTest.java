...
public class GamestatsDAOTest {
	 ...
	 *
	 */
	private GamestatsDAO dataStore;

	/**
	 * Instantiates a new GamestatsDAOTest.
	 *
	 */
	public GamestatsDAOTest() {
	}

	/**
	 * Method to test Gamestats domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(GamestatsDAO dataStore) {
