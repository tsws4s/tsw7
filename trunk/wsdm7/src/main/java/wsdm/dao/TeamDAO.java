...
public interface TeamDAO extends JpaDao<Team> {
	 ...
	 *
	 */
	public Team findTeamByPrimaryKey(Integer teamId_1) throws DataAccessException;

	/**
	 * JPQL Query - findTeamByPrimaryKey
	 *
	 */
	public Team findTeamByPrimaryKey(Integer teamId_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Team> findTeamByTeamName(String teamName_1) throws DataAccessException;

	/**
	 * JPQL Query - findTeamByTeamName
	 *
	 */
	public Set<Team> findTeamByTeamName(String teamName_1, int startResult, int maxRows) throws DataAccessException;
