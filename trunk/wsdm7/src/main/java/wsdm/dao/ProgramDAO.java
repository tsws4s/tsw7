...
public interface ProgramDAO extends JpaDao<Program> {
	 ...
	 *
	 */
	public Set<Program> findProgramByStartDateAfter(Calendar startDate, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Program> findProgramByStartDateBefore(java.util.Calendar startDate_1) throws DataAccessException;

	/**
	 * JPQL Query - findProgramByStartDateBefore
	 *
	 */
	public Set<Program> findProgramByStartDateBefore(Calendar startDate_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Program> findProgramByStartDate(java.util.Calendar startDate_2) throws DataAccessException;

	/**
	 * JPQL Query - findProgramByStartDate
	 *
	 */
	public Set<Program> findProgramByStartDate(Calendar startDate_2, int startResult, int maxRows) throws DataAccessException;
