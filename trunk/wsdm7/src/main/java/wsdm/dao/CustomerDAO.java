...
public interface CustomerDAO extends JpaDao<Customer> {
	 ...
	 *
	 */
	public Customer findCustomerByPrimaryKey(Integer customerId_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerByPrimaryKey
	 *
	 */
	public Customer findCustomerByPrimaryKey(Integer customerId_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Customer> findCustomerByPassword(String password_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerByPassword
	 *
	 */
	public Set<Customer> findCustomerByPassword(String password_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Customer> findCustomerBySelectThemeContaining(String selectTheme_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerBySelectThemeContaining
	 *
	 */
	public Set<Customer> findCustomerBySelectThemeContaining(String selectTheme_1, int startResult, int maxRows) throws DataAccessException;
