...
@NamedQueries({
		...
		@NamedQuery(name = "findProgramresourceByResourceFk", query = "select myProgramresource from Programresource myProgramresource where myProgramresource.resourceFk = ?1"),
		@NamedQuery(name = "findProgramresourceByResourcePriceFk", query = "select myProgramresource from Programresource myProgramresource where myProgramresource.resourcePriceFk = ?1") })
