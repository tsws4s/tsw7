...
@NamedQueries({
		...
		@NamedQuery(name = "findTswacctsportByNumPrograms", query = "select myTswacctsport from Tswacctsport myTswacctsport where myTswacctsport.numPrograms = ?1"),
		...
		@NamedQuery(name = "findTswacctsportBySportFk", query = "select myTswacctsport from Tswacctsport myTswacctsport where myTswacctsport.sportFk = ?1"),
		@NamedQuery(name = "findTswacctsportByTswAcctSportId", query = "select myTswacctsport from Tswacctsport myTswacctsport where myTswacctsport.tswAcctSportId = ?1") })
