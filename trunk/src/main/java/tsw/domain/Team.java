...
@NamedQueries({
		...
		@NamedQuery(name = "findAllTeams4tsw", query = "select myTeam from Team myTeam where tswAcctFk = ?1"),
		...
		@NamedQuery(name = "findTeamByTeamName", query = "select myTeam from Team myTeam where tswAcctfk = ?1 and programFk = ?2 and myTeam.teamName = ?3"),
...
@Table(catalog = "tsws4s_4", name = "Team")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "tsw7/tsw/domain", name = "Team")
...
public class Team implements Serializable {
	...
	/**
	 */
	@OneToMany(mappedBy = "teamByVisitorTeamFk", fetch = FetchType.LAZY)
	@XmlElement(name = "", namespace = "")
	java.util.Set<tsw.domain.Game> gamesForVisitorTeamFk;
	/**
	 */
	...
	/**
	 */
	@OneToMany(mappedBy = "teamByHomeTeamFk", fetch = FetchType.LAZY)
	@XmlElement(name = "", namespace = "")
	java.util.Set<tsw.domain.Game> gamesForHomeTeamFk;
	...
	public Set<Game> getGamesForVisitorTeamFk() {
		if (gamesForVisitorTeamFk == null) {
			gamesForVisitorTeamFk = new java.util.LinkedHashSet<tsw.domain.Game>();
		}
	...
	public Set<Game> getGamesForHomeTeamFk() {
		if (gamesForHomeTeamFk == null) {
			gamesForHomeTeamFk = new java.util.LinkedHashSet<tsw.domain.Game>();
		}
	...
	public void copy(Team that) {
		...
		setGamesForVisitorTeamFk(new java.util.LinkedHashSet<tsw.domain.Game>(that.getGamesForVisitorTeamFk()));
		setTeamplayerses(new java.util.LinkedHashSet<tsw.domain.Teamplayers>(that.getTeamplayerses()));
		setGamesForHomeTeamFk(new java.util.LinkedHashSet<tsw.domain.Game>(that.getGamesForHomeTeamFk()));
	}
