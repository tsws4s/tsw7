...
public class RequirementDAOTest {
	 ...
	 *
	 */
	private RequirementDAO dataStore;

	/**
	 * Instantiates a new RequirementDAOTest.
	 *
	 */
	public RequirementDAOTest() {
	}

	/**
	 * Method to test Requirement domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(RequirementDAO dataStore) {
