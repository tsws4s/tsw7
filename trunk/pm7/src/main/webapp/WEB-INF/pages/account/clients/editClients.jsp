...
<html>
<head>
<title>Edit <fmt:message key="account.title"/> <fmt:message key="client.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAccountClients" method="POST" modelAttribute="client">
