...
<html>
<head>
<title>Edit <fmt:message key="account.title"/> <fmt:message key="projecttemplate.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		<h1><fmt:message key="navigation.edit"/> <fmt:message key="projecttemplate.title"/></h1>
		...
		<form:form action="${pageContext.request.contextPath}/saveAccountProjecttemplates" method="POST" modelAttribute="projecttemplate">
