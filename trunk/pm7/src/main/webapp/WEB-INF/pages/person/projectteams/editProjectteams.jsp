...
<html>
<head>
<title>Edit <fmt:message key="person.title"/> <fmt:message key="projectteam.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		<h1><fmt:message key="navigation.edit"/> <fmt:message key="projectteam.title"/></h1>
		...
		<form:form action="${pageContext.request.contextPath}/savePersonProjectteams" method="POST" modelAttribute="projectteam">
				...
				<tbody>
					<tr>
						...
						<td>
							<c:choose>
								<c:when test='${newFlag}' >
							<form:input id="projectteam_projectTeamId" path="projectTeamId" cssStyle="width:300px;"/>
					...
					<tr>
						...
						<td>
							<form:input id="projectteam_projectRole" path="projectRole" cssStyle="width:300px;"/>
					...
					<tr>
						...
						<td>
							<form:input id="projectteam_personProjectEstHrs" path="personProjectEstHrs" cssStyle="width:300px;"/>
					...
					<tr>
						...
						<td>
							<form:input id="projectteam_personProjectActualHrs" path="personProjectActualHrs" cssStyle="width:300px;"/>
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="person_personId" value="${person_personId}" >
