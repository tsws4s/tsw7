...
<html>
<head>
<title>Edit <fmt:message key="releaseplan.title"/> <fmt:message key="changerequest.title"/></title>
</head>
<body>

	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveReleaseplanChangerequests?releaseplan_releaseId=${releaseplan_releaseId}&" method="POST" modelAttribute="changerequest" name="parentform">
						<div class="tabs">
							<ul>
