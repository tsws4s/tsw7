...
<html>
<head>
<title>View <fmt:message key="task.title"/> <fmt:message key="timeentry.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteTaskTimeentries?task_taskId=${task_taskId}&related_timeentries_timeEntryId=${timeentry.timeEntryId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
