...
<html>
<head>
<title>View <fmt:message key="project.title"/> <fmt:message key="projectteam.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteProjectProjectteams?project_projectId=${project_projectId}&related_projectteams_projectTeamId=${projectteam.projectTeamId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
