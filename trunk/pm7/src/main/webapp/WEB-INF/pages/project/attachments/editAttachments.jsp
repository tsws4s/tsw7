...
<html>
<head>
<title>Edit <fmt:message key="project.title"/> <fmt:message key="attachment.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProjectAttachments" method="POST" modelAttribute="attachment">
