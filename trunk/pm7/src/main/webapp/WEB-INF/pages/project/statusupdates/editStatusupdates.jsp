...
<html>
<head>
<title>Edit <fmt:message key="project.title"/> <fmt:message key="statusupdate.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProjectStatusupdates" method="POST" modelAttribute="statusupdate">
