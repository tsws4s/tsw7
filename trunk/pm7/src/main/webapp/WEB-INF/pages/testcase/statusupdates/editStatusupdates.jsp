...
<html>
<head>
<title>Edit <fmt:message key="testcase.title"/> <fmt:message key="statusupdate.title"/></title>
<script>
...
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveTestcaseStatusupdates?testcase_testId=${testcase_testId}&" method="POST" modelAttribute="statusupdate" name="parentform">
						<div class="tabs">
							<ul>
