...
<html>
<head>
<title>Edit <fmt:message key="testcase.title"/> <fmt:message key="attachment.title"/></title>
</head>
<body>
	<div class="panel-wrapper">
		<div class="panel">
		<form:form action="${pageContext.request.contextPath}/saveTestcaseAttachments?testcase_testId=${testcase_testId}&" method="POST" modelAttribute="attachment" name="parentform">
						<div class="tabs">
							<ul>
