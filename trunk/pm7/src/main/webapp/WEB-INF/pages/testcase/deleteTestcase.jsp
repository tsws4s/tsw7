...
<html>
<head>
<title>Confirm Delete <fmt:message key="testcase.title"/></title>
</head>
<body>
						...
						<div class="tabs">
							<ul>
								...
								<img src="css/images/icons/icon-user.png" alt="">
									&nbsp;&nbsp;<fmt:message key="navigation.delete"/> <fmt:message key="testcase.title"/> 
								</a></li>
							</ul>
...
<div style="padding-left:200px;padding-top:7px;padding-bottom:7px;background-color:rgb(239, 239, 239);">						
	<a class="button-red" href="${pageContext.request.contextPath}/deleteTestcase?testIdKey=${testcase.testId}&">Confirm Delete <img alt="" src="css/images/icons/icon-delete.png"></a>
