...
<html>
<head>
<title>Edit <fmt:message key="invoice.title"/> <fmt:message key="client.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveInvoiceClient" method="POST" modelAttribute="client">
