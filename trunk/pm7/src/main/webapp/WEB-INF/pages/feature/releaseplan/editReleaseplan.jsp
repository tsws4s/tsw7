...
<html>
<head>
<title>Edit <fmt:message key="feature.title"/> <fmt:message key="releaseplan.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveFeatureReleaseplan" method="POST" modelAttribute="releaseplan">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="feature_featureId" value="${feature_featureId}" >
