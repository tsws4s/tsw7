...
<html>
<head>
<title>List <fmt:message key="defect.title"/>s</title>
</head>
<body>
				<div class="panel-wrapper">
					<div class="panel">
						...
						&nbsp;&nbsp;Manage <fmt:message key="defect.title"/>s</h4>
			...
			<tbody>
				...
				<a class="icon" href="${pageContext.request.contextPath}/editDefect?defectIdKey=${current.defectId}&"><img src="css/images/icons/icon-edit.png" alt="Edit"></a>
				<a class="icon" href="${pageContext.request.contextPath}/confirmDeleteDefect?defectIdKey=${current.defectId}&"><img src="css/images/icons/icon-delete.png" alt="Delete"></a>
				</td>
	...
	<div style="padding-top:7px;padding-bottom:7px;background-color:rgb(239, 239, 239);">						
		<span style="padding-left:20px;">			
			<a class="button-blue" href="${pageContext.request.contextPath}/newDefect">New Defect <img src="css/images/icons/icon-menu-tasks.png" alt=""></a>
		</span>						
		...
		<div style="float:right;">			
			<ul class="page-navigation">
					<c:choose>
						...
						<c:otherwise>
							<li><a class="prev" href="${pageContext.request.contextPath}/indexDefectFrom?indexFrom=${indexFrom-resultsPerPage}"></a></li>
						</c:otherwise>
					</c:choose>	
					<c:choose>
					...
					<c:choose>
						...
						<c:otherwise>
							<li><a class="next" href="${pageContext.request.contextPath}/indexDefectFrom?indexFrom=${indexFrom+resultsPerPage}"></a></li>
						</c:otherwise>
					</c:choose>	
			</ul>
		</div>	
