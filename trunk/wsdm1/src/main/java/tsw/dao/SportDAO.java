...
public interface SportDAO extends JpaDao<Sport> {
	 ...
	 *
	 */
	public Set<Sport> findSportBySportNameContaining(String sportName_1) throws DataAccessException;

	/**
	 * JPQL Query - findSportBySportNameContaining
	 *
	 */
	public Set<Sport> findSportBySportNameContaining(String sportName_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Sport findSportBySportId(Integer sportId_1) throws DataAccessException;

	/**
	 * JPQL Query - findSportBySportId
	 *
	 */
	public Sport findSportBySportId(Integer sportId_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findSportByWikiUrlContaining
	 *
	 */
	public Set<Sport> findSportByWikiUrlContaining(String wikiUrl_1) throws DataAccessException;

	/**
	 * JPQL Query - findSportByWikiUrlContaining
	 *
	 */
	public Set<Sport> findSportByWikiUrlContaining(String wikiUrl_1, int startResult, int maxRows) throws DataAccessException;
