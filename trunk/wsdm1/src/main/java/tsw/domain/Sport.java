...
@Table(catalog = "tsws4s_4", name = "Sport")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "tsw7/tsw/domain", name = "Sport")
...
public class Sport implements Serializable {
	...
	@Column(name = "resourceType", length = 145)
	@Basic(fetch = FetchType.EAGER)
	@XmlElement
	String resourceType;
	...
	java.util.Set<tsw.domain.Sportstattype> sportstattypes;
	/**
	 */
	@OneToMany(mappedBy = "sport", fetch = FetchType.EAGER)
	@XmlElement(name = "", namespace = "")
	java.util.Set<tsw.domain.Sportposition> sportpositions;
	/**
	 */
	@OneToMany(mappedBy = "sport", fetch = FetchType.LAZY)
	@XmlElement(name = "", namespace = "")
	...
	public Set<Sportstattype> getSportstattypes() {
		if (sportstattypes == null) {
			sportstattypes = new java.util.LinkedHashSet<tsw.domain.Sportstattype>();
		}
	...
	public Set<Sportposition> getSportpositions() {
		if (sportpositions == null) {
			sportpositions = new java.util.LinkedHashSet<tsw.domain.Sportposition>();
		}
	...
	public void copy(Sport that) {
		...
		setSportstattypes(new java.util.LinkedHashSet<tsw.domain.Sportstattype>(that.getSportstattypes()));
		setSportpositions(new java.util.LinkedHashSet<tsw.domain.Sportposition>(that.getSportpositions()));
