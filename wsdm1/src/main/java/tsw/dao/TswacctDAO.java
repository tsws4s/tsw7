...
public interface TswacctDAO extends JpaDao<Tswacct> {
	 ...
	 *
	 */
	public Set<Tswacct> findTswacctByEstablishDate(Calendar establishDate, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Tswacct> findTswacctByExpireDateAfter(Calendar expireDate, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findTswacctByEstablishDateAfter
	 *
	 */
	public Set<Tswacct> findTswacctByEstablishDateAfter(java.util.Calendar establishDate_1) throws DataAccessException;

	/**
	 * JPQL Query - findTswacctByEstablishDateAfter
	 *
	 */
	public Set<Tswacct> findTswacctByEstablishDateAfter(Calendar establishDate_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findTswacctByEstablishDateBefore
	 *
	 */
	public Set<Tswacct> findTswacctByEstablishDateBefore(java.util.Calendar establishDate_2) throws DataAccessException;

	/**
	 * JPQL Query - findTswacctByEstablishDateBefore
	 *
	 */
	public Set<Tswacct> findTswacctByEstablishDateBefore(Calendar establishDate_2, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Tswacct> findTswacctByExpireDate(java.util.Calendar expireDate_1) throws DataAccessException;

	/**
	 * JPQL Query - findTswacctByExpireDate
	 *
	 */
	public Set<Tswacct> findTswacctByExpireDate(Calendar expireDate_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findTswacctByExpireDateBefore
	 *
	 */
	public Set<Tswacct> findTswacctByExpireDateBefore(java.util.Calendar expireDate_2) throws DataAccessException;

	/**
	 * JPQL Query - findTswacctByExpireDateBefore
	 *
	 */
	public Set<Tswacct> findTswacctByExpireDateBefore(Calendar expireDate_2, int startResult, int maxRows) throws DataAccessException;
