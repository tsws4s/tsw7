...
public interface ProgramresourceDAO extends JpaDao<Programresource> {
	 ...
	 *
	 */
	public Programresource findProgramresourceByProgramResourceId(Integer programResourceId_1) throws DataAccessException;

	/**
	 * JPQL Query - findProgramresourceByProgramResourceId
	 *
	 */
	public Programresource findProgramresourceByProgramResourceId(Integer programResourceId_1, int startResult, int maxRows) throws DataAccessException;
