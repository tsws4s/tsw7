...
public interface EventDAO extends JpaDao<Event> {
	 ...
	 *
	 */
	public Set<Event> findEventByEventType(String eventType_1) throws DataAccessException;

	/**
	 * JPQL Query - findEventByEventType
	 *
	 */
	public Set<Event> findEventByEventType(String eventType_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Event findEventByEventId(Integer eventId_1) throws DataAccessException;

	/**
	 * JPQL Query - findEventByEventId
	 *
	 */
	public Event findEventByEventId(Integer eventId_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findEventByDescriptionContaining
	 *
	 */
	public Set<Event> findEventByDescriptionContaining(String description_1) throws DataAccessException;

	/**
	 * JPQL Query - findEventByDescriptionContaining
	 *
	 */
	public Set<Event> findEventByDescriptionContaining(String description_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findEventByEventNameContaining
	 *
	 */
	public Set<Event> findEventByEventNameContaining(String eventName_1) throws DataAccessException;

	/**
	 * JPQL Query - findEventByEventNameContaining
	 *
	 */
	public Set<Event> findEventByEventNameContaining(String eventName_1, int startResult, int maxRows) throws DataAccessException;
