...
public interface PriceDAO extends JpaDao<Price> {
	 ...
	 *
	 */
	public Set<Price> findPriceByPriceColor(String priceColor_1) throws DataAccessException;

	/**
	 * JPQL Query - findPriceByPriceColor
	 *
	 */
	public Set<Price> findPriceByPriceColor(String priceColor_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Price> findPriceByPriceCategory(String priceCategory_1) throws DataAccessException;

	/**
	 * JPQL Query - findPriceByPriceCategory
	 *
	 */
	public Set<Price> findPriceByPriceCategory(String priceCategory_1, int startResult, int maxRows) throws DataAccessException;
