...
public interface SportstattypeDAO extends JpaDao<Sportstattype> {
	 ...
	 *
	 */
	public Sportstattype findSportstattypeBySportStatTypeId(Integer sportStatTypeId_1) throws DataAccessException;

	/**
	 * JPQL Query - findSportstattypeBySportStatTypeId
	 *
	 */
	public Sportstattype findSportstattypeBySportStatTypeId(Integer sportStatTypeId_1, int startResult, int maxRows) throws DataAccessException;
