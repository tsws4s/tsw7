...
@Entity
@NamedQueries({
		@NamedQuery(name = "findAllTemplatetimeslots", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot"),
		@NamedQuery(name = "findTemplatetimeslotByDailyTemplateFk", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot where myTemplatetimeslot.dailyTemplateFk = ?1"),
		@NamedQuery(name = "findTemplatetimeslotByEndTime", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot where myTemplatetimeslot.endTime = ?1"),
		@NamedQuery(name = "findTemplatetimeslotByPriceFk", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot where myTemplatetimeslot.priceFk = ?1"),
		@NamedQuery(name = "findTemplatetimeslotByPrimaryKey", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot where myTemplatetimeslot.timeSlotId = ?1"),
		@NamedQuery(name = "findTemplatetimeslotBySlotNum", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot where myTemplatetimeslot.slotNum = ?1"),
		@NamedQuery(name = "findTemplatetimeslotByStartTime", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot where myTemplatetimeslot.startTime = ?1"),
		@NamedQuery(name = "findTemplatetimeslotByTimeSlotId", query = "select myTemplatetimeslot from Templatetimeslot myTemplatetimeslot where myTemplatetimeslot.timeSlotId = ?1") })
