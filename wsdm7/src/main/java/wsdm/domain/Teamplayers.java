...
@NamedQueries({
		...
		@NamedQuery(name = "findTeamplayersByCaptain", query = "select myTeamplayers from Teamplayers myTeamplayers where myTeamplayers.captain = ?1"),
		...
		@NamedQuery(name = "findTeamplayersByOtherAmtPaid", query = "select myTeamplayers from Teamplayers myTeamplayers where myTeamplayers.otherAmtPaid = ?1"),
