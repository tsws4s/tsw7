...
@NamedQueries({
		...
		@NamedQuery(name = "findUsersByResultsPerPage", query = "select myUsers from Users myUsers where myUsers.resultsPerPage = ?1"),
		@NamedQuery(name = "findUsersBySelectTheme", query = "select myUsers from Users myUsers where myUsers.selectTheme = ?1"),
		@NamedQuery(name = "findUsersBySelectThemeContaining", query = "select myUsers from Users myUsers where myUsers.selectTheme like ?1"),
...
@XmlType(namespace = "wsdm7/wsdm/domain", name = "Users")
