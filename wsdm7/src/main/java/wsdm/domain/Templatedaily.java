...
@Entity
@NamedQueries({
		@NamedQuery(name = "findAllTemplatedailys", query = "select myTemplatedaily from Templatedaily myTemplatedaily"),
		@NamedQuery(name = "findTemplatedailyByDailyTemplateId", query = "select myTemplatedaily from Templatedaily myTemplatedaily where myTemplatedaily.dailyTemplateId = ?1"),
		@NamedQuery(name = "findTemplatedailyByDescription", query = "select myTemplatedaily from Templatedaily myTemplatedaily where myTemplatedaily.description = ?1"),
		@NamedQuery(name = "findTemplatedailyByDescriptionContaining", query = "select myTemplatedaily from Templatedaily myTemplatedaily where myTemplatedaily.description like ?1"),
		@NamedQuery(name = "findTemplatedailyByNumTimeSlots", query = "select myTemplatedaily from Templatedaily myTemplatedaily where myTemplatedaily.numTimeSlots = ?1"),
		@NamedQuery(name = "findTemplatedailyByPrimaryKey", query = "select myTemplatedaily from Templatedaily myTemplatedaily where myTemplatedaily.dailyTemplateId = ?1"),
		@NamedQuery(name = "findTemplatedailyByTemplateName", query = "select myTemplatedaily from Templatedaily myTemplatedaily where myTemplatedaily.templateName = ?1"),
		@NamedQuery(name = "findTemplatedailyByTemplateNameContaining", query = "select myTemplatedaily from Templatedaily myTemplatedaily where myTemplatedaily.templateName like ?1") })
