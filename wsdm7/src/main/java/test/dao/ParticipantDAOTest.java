...
public class ParticipantDAOTest {
	 ...
	 *
	 */
	private ParticipantDAO dataStore;

	/**
	 * Instantiates a new ParticipantDAOTest.
	 *
	 */
	...
	/**
	 * Method to test Participant domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(ParticipantDAO dataStore) {
