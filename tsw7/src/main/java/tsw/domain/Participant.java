...
@NamedQueries({
		...
		@NamedQuery(name = "findParticipantByActiveYn", query = "select myParticipant from Participant myParticipant where myParticipant.activeYn = ?1"),
		@NamedQuery(name = "findParticipantByAmtPaid", query = "select myParticipant from Participant myParticipant where myParticipant.amtPaid = ?1"),
		@NamedQuery(name = "findParticipantByGroup1", query = "select myParticipant from Participant myParticipant where myParticipant.group1 = ?1"),
		@NamedQuery(name = "findParticipantByGroup1Containing", query = "select myParticipant from Participant myParticipant where myParticipant.group1 like ?1"),
		@NamedQuery(name = "findParticipantByNotes", query = "select myParticipant from Participant myParticipant where myParticipant.notes = ?1"),
		@NamedQuery(name = "findParticipantByNotesContaining", query = "select myParticipant from Participant myParticipant where myParticipant.notes like ?1"),
		@NamedQuery(name = "findParticipantByParticipantId", query = "select myParticipant from Participant myParticipant where myParticipant.participantId = ?1"),
		...
		@NamedQuery(name = "findParticipantBySignedWaiverYn", query = "select myParticipant from Participant myParticipant where myParticipant.signedWaiverYn = ?1") })
@Table(catalog = "tsws4s_4", name = "Participant")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "tsw7/tsw/domain", name = "Participant")
