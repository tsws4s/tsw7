...
public interface CustomerDAO extends JpaDao<Customer> {
	...
	public Customer findCustomerByName(Tswacct tswacct, String firstname, String lastname);
	public Customer findCustomerByName(Tswacct tswacct, String firstname, String lastname, int startResult, int maxRows);
	 ...
	 *
	 */
	public Set<Customer> findCustomerByLastnameContaining4tsw(String lastname_1, int startResult, int maxRows, Integer tswId) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Customer> findCustomerByFirstnameContaining4tsw(String firstname_1, int startResult, int maxRows, Integer tswId) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Customer> findCustomerByEmail(String email_1) throws DataAccessException;

	public Customer findCustomerByEmailAddr(String email_1) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Customer> findCustomerByEmail(String email_1, int startResult, int maxRows) throws DataAccessException;
