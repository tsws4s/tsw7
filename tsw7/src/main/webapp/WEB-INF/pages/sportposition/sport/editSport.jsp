...
<html>
<head>
<title>Edit <fmt:message key="sportposition.title"/> <fmt:message key="sport.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSportpositionSport" method="POST" modelAttribute="sport">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="sportposition_sportPositionId" value="${sportposition_sportPositionId}" >
