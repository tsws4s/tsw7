...
<html>
<head>
<title>Edit <fmt:message key="sport.title"/> <fmt:message key="sportposition.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSportSportpositions" method="POST" modelAttribute="sportposition">
