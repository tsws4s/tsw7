...
<html>
<head>
<title>Edit <fmt:message key="sport.title"/> <fmt:message key="program.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSportPrograms" method="POST" modelAttribute="program">
