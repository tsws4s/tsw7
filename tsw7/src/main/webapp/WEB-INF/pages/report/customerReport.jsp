...
<div id="content">
	...
	<div id="header">
			<ul class="nav" style="text-align:center;">
				...
				<li>
				<a href="/" onclick="window.showModalDialog('${pageContext.request.contextPath}/viewReport?rptName=Customers', 'myWin2','dialogWidth:850px;dialogHeight:700px;help:no;border:thin;status:no;toolbar=yes;menubar=yes'); return false">
