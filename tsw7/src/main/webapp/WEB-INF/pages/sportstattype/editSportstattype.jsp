...
<html>
<head>
<title>Edit <fmt:message key="sportstattype.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSportstattype" method="POST" modelAttribute="sportstattype">
